var myapp = angular.module('myApp', ["ngResource", "ngRoute", "ngMessages", "ngTouch", "ngAnimate", "cgBusy", "vcRecaptcha", "ui.bootstrap"]);
...
myapp.config(function ($routeProvider) {
	...
	$routeProvider.when("/registrationStep2", {
		templateUrl: "pages/registrationStep2.html",
		controller: "registerController"
	});
	...
	$routeProvider.when("/forgotUserLogin", {
		templateUrl: "pages/forgotUserLogin.html",
		controller: "loginController"
	});

	
	$routeProvider.when("/userHomeTileDashboard", {
		templateUrl: "pages/userHomeTileDashboard.html",
		controller: "homeTileDashboardController"
	});
